...
const description =
  "Paste any draft for a clear AI-detection result. Check 200-500 words free (3 checks a day), then sign up to scan longer text and see the full report.";
...
export default function AiDetectorPage() {
  return (
    <ToolMarketingPage
      ...
      description="Paste the draft you are unsure about. Get a clear detector result in seconds, then review the sentence-level signals."
      details={[
        { title: "A real detector, not a guess", body: "Your result comes from a verified detection model, not just a list of suspicious words." },
        { title: "Sentence-by-sentence detail", body: "Signed-in reports show the lines carrying the strongest signals, so you can judge the result in context." },
      ...
      faq={[
        ...
        { q: "Why is there a 200-word minimum?", a: "AI detectors, ours included, are unreliable on short text, close to a coin flip below a couple hundred words. We would rather ask for more text than give you a result we do not trust." },
        { q: "Can an AI detector be certain?", a: "No. A detection result is a signal, not proof. Review it in context, especially for short or heavily edited text." },
